    ...
    <div class="flex-1 flex flex-col h-full min-w-0 overflow-hidden">
        ...
        <header class="bg-white dark:bg-[#121212] border-b border-slate-100 dark:border-[#262626] px-4 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between shadow-xs flex-shrink-0 z-20 gap-3">
            ...
            <div class="flex items-center gap-3 sm:gap-4 shrink-0">
                ...
                <!-- Theme Toggle (Hanya Putih & Hitam Saja) -->
                <button type="button" onclick="toggleTheme()" class="p-2 rounded-xl text-black dark:text-white hover:bg-slate-100 dark:hover:bg-[#1a1a1a] transition-colors flex items-center justify-center border border-slate-200/80 dark:border-[#262626]" title="Beralih Mode Gelap / Terang">
        ...
        <main class="flex-1 overflow-y-auto p-3 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div id="tab-pengaturan-profil" class="tab-content hidden space-y-6">
                <div class="max-w-4xl mx-auto space-y-6">
                    <form action="update_profile.php" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-[#161616] rounded-3xl border border-slate-200/80 dark:border-[#262626] shadow-sm p-6 md:p-8 space-y-6">
                        ...
                        <!-- Card 1: Data Informasi Akun -->
                        <div class="border border-slate-200/80 dark:border-[#262626] rounded-2xl p-6 bg-white dark:bg-[#161616] space-y-5">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-[#ecf7ed] dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0">
                            ...
                            <!-- Foto Profil Upload Dashed Box -->
                            <div class="border border-dashed border-emerald-300/80 dark:border-emerald-800/60 rounded-2xl p-5 flex flex-col md:flex-row items-center justify-between gap-6 bg-emerald-50/20 dark:bg-emerald-950/10">
                                ...
                                <div id="profileDropZone" class="border-t md:border-t-0 md:border-l border-slate-200/80 dark:border-[#2a2a2a] pt-4 md:pt-0 md:pl-8 flex flex-col items-center justify-center text-center cursor-pointer min-w-[200px] w-full md:w-auto hover:opacity-80 transition-opacity" onclick="document.getElementById('profilePhotoInput').click()">
                        ...
                        <!-- Card 2: Ubah Kata Sandi (Tanpa Badge / Emoji Icon di Samping Judul) -->
                        <div class="border border-slate-200/80 dark:border-[#262626] rounded-2xl p-6 bg-white dark:bg-[#161616] space-y-4">
                            <div>
