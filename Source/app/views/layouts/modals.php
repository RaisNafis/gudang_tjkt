...
<div id="modalFotoPreview" class="fixed inset-0 z-50 hidden items-center justify-center p-3 sm:p-4 overflow-y-auto md:p-8 bg-slate-950/90 cursor-pointer" onclick="if(event.target === this) closeModal('modalFotoPreview')">
    <div class="relative flex items-center justify-center cursor-default">
        ...
        <div class="absolute -top-12 -right-2 md:-top-14 md:-right-2 flex items-center gap-3 z-20 max-w-[92vw]">
            <!-- NAMA BARANG / JUDUL (DI UJUNG KIRI DARI TOMBOL AKSI, HANYA TEKS TANPA CARD) -->
            <div id="previewFotoTitleBox" class="hidden items-center pr-1 text-white max-w-[200px] sm:max-w-[340px] md:max-w-[480px]">
