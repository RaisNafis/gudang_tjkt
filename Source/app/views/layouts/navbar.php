...
<header class="bg-white dark:bg-slate-900 border-b border-sage-200/80 dark:border-slate-800 px-4 sm:px-6 py-3.5 flex items-center justify-between shadow-sm sticky top-0 z-30">
    ...
    <?php if ($user): ?>
        ...
        <div class="flex items-center gap-3 shrink-0">
            <button type="button" onclick="toggleTheme()" class="p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 transition-colors" title="Beralih Mode Gelap / Terang">
                <svg class="themeSunIcon w-5 h-5 hidden text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
                </svg>
                <svg class="themeMoonIcon w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
